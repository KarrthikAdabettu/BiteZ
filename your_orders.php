														 ...
														 <td data-column="Item"> <?php echo $row['title']; ?></td>
														  ...
														  <td data-column="price">$<?php echo $row['price']; ?></td>
														   ...
														   <?php 
																			...
																			{
																			?>
																			<button type="button" class="btn btn-info"><span class="fa fa-bars"  aria-hidden="true" ></span> Preparing</button>
																		   <?php 
																			  }
																			...
																			if($status=="closed")
																				{
																			?>
																			 <button type="button" class="btn btn-success" ><span  class="fa fa-check-circle" aria-hidden="true"></span> Ready</button> 
																			<?php 
																			} 
																			?>
																			<?php
                        ...
                        <div class="container">
                            <div class="row">
                                ...
                                <div class="col-xs-12 col-sm-4 address color-gray">
                                    <h5>Address</h5>
                                    <p>RVCE campus</p>
                                    <h5>Phone: 9019846609</a></h5> </div>
                                <div class="col-xs-12 col-sm-5 additional-info color-gray">
                                    <h5>Addition informations</h5>
                                   <p>Join thousands of other canteens and restaurants who benefit from having partnered with us.</p>
                                </div>
                            </div>
                        </div>
                    </div>
